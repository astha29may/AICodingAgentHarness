...
# Usage: powershell -ExecutionPolicy Bypass -File .github/scripts/render-diagrams.ps1
#   (or, if PowerShell 7+ is installed: pwsh -File .github/scripts/render-diagrams.ps1)
