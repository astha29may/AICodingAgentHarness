...
| Path | Responsibility |
| --- | --- |
| `.github/` | Copilot instructions, agents, skills, and harness self-docs (`.github/docs/`) |
| `.github/docs/` | System-level documentation (design, deployment, testing, observability, evaluation) |
